...
class ScriptRunner {
    ...
    executeFile() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filePath = yield FileUtils_1.default.createScriptFile(new ScriptBuilder_1.default()
                .getInlineScriptFile(this.inlineScript, this.errorActionPreference));
            core.debug(`script file to run: ${filePath}`);
            yield PowerShellToolRunner_1.default.init();
            const exitCode = yield PowerShellToolRunner_1.default.executePowerShellScriptBlock(filePath, options);
            if (exitCode !== 0) {
