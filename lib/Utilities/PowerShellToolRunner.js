...
class PowerShellToolRunner {
    ...
    static executePowerShellCommand(command, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            yield exec.exec(`${PowerShellToolRunner.psPath} -Command ${command}`, PowerShellToolRunner.args, options);
        });
    }
    static executePowerShellScriptBlock(scriptBlock, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            PowerShellToolRunner.args.push(scriptBlock);
            const exitCode = yield exec.exec(`${PowerShellToolRunner.psPath} -Command`, PowerShellToolRunner.args, options);
            return exitCode;
        });
    }
}
exports.default = PowerShellToolRunner;
PowerShellToolRunner.args = ['-NoLogo', '-NoProfile', '-NonInteractive'];
