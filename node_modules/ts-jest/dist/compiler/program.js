...
exports.compileUsingProgram = function (configs, logger, memoryCache) {
    ...
    var updateMemoryCache = function (code, fileName) {
        ...
        if (!compiler_utils_1.hasOwn.call(memoryCache.versions, fileName)) {
        ...
        compileFn: function (code, fileName) {
            ...
            if (cacheDir) {
                if (micromatch.isMatch(normalizedFileName, configs.testMatchPatterns)) {
                    compiler_utils_1.cacheResolvedModules(normalizedFileName, memoryCache, program, cacheDir, logger);
                }
                else {
