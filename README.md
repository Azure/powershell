...
Azure PowerShell actions is supported on both 'AzureUSGovernment' or 'AzureChinaCloud'.Login to Azure before running Azure PowerShell scripts using [Azure Login](https://github.com/Azure/login)
